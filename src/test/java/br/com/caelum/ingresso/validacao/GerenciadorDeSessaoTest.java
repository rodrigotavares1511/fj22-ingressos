...
public class GerenciadorDeSessaoTest {
	...
	public void garanteQueNaoDevePermitirSessaoNoMesmoHorario() {
		...
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "Sci-fi", new BigDecimal("10"));
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		Sala sala = new Sala("", new BigDecimal("10"));
		Filme filme1 = new Filme("Rogue	One", Duration.ofMinutes(90), "SCI-FI", new BigDecimal("10"));
		LocalTime dezHoras = LocalTime.parse("10:00:00");
		Sessao sessaoDasDez = new Sessao(dezHoras, filme1, sala);
		Filme filme2 = new Filme("Rogue	One", Duration.ofMinutes(120), "SCI-FI", new BigDecimal("10"));
